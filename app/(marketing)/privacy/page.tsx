            ...
            <div>
              ...
              <div className="space-y-3 text-sm text-gray-700 dark:text-gray-300 leading-relaxed">
                <p>
                  ...
                  subsidiaries or its affiliates. The official YNAB website can
                  be found at{" "}
                  <a
                ...
                <p>
                  <strong>Splitwise:</strong> We are not affiliated, associated,
                  or in any way officially connected with Splitwise, or any of
                  its subsidiaries or its affiliates. The official Splitwise
                  ...
                  . The name Splitwise as well as related names, marks, emblems
                  and images are registered trademarks of Splitwise, Inc.
                </p>
              </div>
            </div>
          </div>
          ...
          <CardContent className="p-8">
            ...
            <div className="space-y-4 text-gray-600 dark:text-gray-300">
              ...
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li>
                  <strong>Secure Storage:</strong> Data is stored in secure, SOC
                  2 compliant cloud infrastructure with regular security audits
                </li>
                <li>
                ...
                <li>
                  <strong>Data Minimization:</strong> We only store the minimum
                  data necessary to provide our synchronization service
                </li>
                <li>
              ...
              <div className="bg-emerald-50 dark:bg-emerald-900/20 p-4 rounded-xl border border-emerald-200 dark:border-emerald-800 mt-6">
                ...
                <ul className="text-sm text-emerald-700 dark:text-emerald-300 space-y-1">
                  ...
                  <li>
                    • We respect Splitwise&apos;s terms of service and API usage
                    guidelines
                  </li>
                  <li>
          ...
          <CardContent className="p-8">
            ...
            <div className="space-y-4 text-gray-600 dark:text-gray-400">
              <div className="bg-emerald-50 dark:bg-emerald-900/20 p-4 rounded-xl border border-emerald-200 dark:border-emerald-800">
                <div className="space-y-2">
                  ...
                  <ul className="text-sm text-emerald-700 dark:text-emerald-300 space-y-1">
                    ...
                    <li>
                      • <strong>Splitwise Data:</strong> Will not unknowingly be
                      passed to any third-party
                    </li>
                    <li>
                      • <strong>Cross-Platform:</strong> Data flows only between
                      YNAB and Splitwise as you explicitly direct
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li>
                  <strong>Service Providers:</strong> We only work with trusted
                  service providers (hosting, monitoring) who are bound by
                  strict data protection agreements
                </li>
                <li>
                  <strong>Legal Requirements:</strong> We will only disclose
                  data if required by law, and we will notify you unless legally
                  prohibited
                </li>
                <li>
              ...
              <div className="bg-gray-50 dark:bg-gray-800/50 p-4 rounded-xl border border-gray-200 dark:border-gray-700">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  Any data sharing will always be with your explicit consent and
                  for the direct purpose of providing our synchronization
          ...
          <CardContent className="p-8">
            ...
            <div className="space-y-4 text-gray-600 dark:text-gray-400">
              ...
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li>
                  <strong>Selective Control:</strong> Choose which transactions
                  to sync and which to keep private
                </li>
              </ul>
        ...
        <Card className="bg-white dark:bg-[#141414] border-gray-200 dark:border-gray-800 rounded-xl">
          <CardContent className="p-8">
            ...
            <div className="space-y-4 text-gray-600 dark:text-gray-400">
              <ul className="list-disc pl-6 space-y-2">
                <li>
                  <strong>Active Accounts:</strong> We retain your data as long
                  as your account is active and you&apos;re using our service
                </li>
                <li>
          ...
          <CardContent className="p-8">
            ...
            <div className="space-y-4 text-gray-600 dark:text-gray-400">
              ...
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li>
                  <strong>Token Security:</strong> API tokens are encrypted and
                  stored securely with automatic rotation
                </li>
                <li>
