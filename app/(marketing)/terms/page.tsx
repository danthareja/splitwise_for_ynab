      ...
      <div className="space-y-8">
          ...
          <CardContent className="p-8">
            ...
            <div className="space-y-4 text-gray-600 dark:text-gray-400">
              ...
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li>
                  <strong>Responsible Use:</strong> Use the Service only for its
                  intended purpose
                </li>
                <li>
        ...
        <Card className="bg-white dark:bg-[#141414] border-gray-200 dark:border-gray-800 rounded-xl">
          <CardContent className="p-8">
            ...
            <div className="space-y-4 text-gray-600 dark:text-gray-400">
              <p>
                Our Service operates within the constraints of third-party APIs:
              </p>
              <ul className="list-disc pl-6 space-y-2">
                <li>
                ...
                <li>
                  <strong>Feature Limitations:</strong> Our features are limited
                  by what the APIs allow
                </li>
              </ul>
            </div>
          </CardContent>
